...
This means that the last test case will raise an error.

To bypass this limitation, we can use set sys.set_int_max_str_digits from the sys module to a new upper limit.
First, we import the sys module, then we call sys.set_int_max_str_digits with the maximum digits desired for string conversion.
'''
import sys
