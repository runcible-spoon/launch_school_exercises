...
def rotate90(matrix):
    ...
    for row_idx in range(len(matrix) - 1, -1, -1):
        for col_idx in range(len(matrix[row_idx]) - 1, -1, -1):
...
print(new_matrix1 == [[3, 4, 1], [9, 7, 5], [6, 2, 8]]) # True

new_matrix2 = rotate90(matrix2)
print(new_matrix2 == [[5, 3], [1, 7], [0, 4], [8, 2]]) # True


new_matrix3 = rotate90(rotate90(rotate90(rotate90(matrix2))))
print(new_matrix3 == matrix2) # True
