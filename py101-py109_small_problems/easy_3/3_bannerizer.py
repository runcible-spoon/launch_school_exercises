        ...
        if len(message) > max_width:
            ...
            for _ in range(number_of_overruns):
                ...
                if len(message) < max_width:
                    ...
                    message_line = f'| {message}{" " * spaces_from_right} |'

                    print("Final line: ", message_line)
                    break
                
                split_message = message.split()

                truncated_message = split_message

                print("Truncated: ", truncated_message)

                message_line = f'| {truncated_message[:max_width]} |'
